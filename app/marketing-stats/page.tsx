    ...
    <div className="p-6 max-w-7xl mx-auto">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-slate-600 dark:text-slate-400 mt-2">
              Manage public-facing statistics, testimonials, and trusted company
              logos
            </p>
          </div>
      ...
      {activeTab === "testimonials" && (
        <div className="space-y-6">
          {/* Add New Testimonial */}
          <div className="bg-white dark:bg-slate-800 rounded-xl p-6 border border-slate-200 dark:border-slate-700">
            <h3 className="font-semibold text-lg mb-4">Add New Testimonial</h3>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            {stats.trustedByLogos.map((logo, index) => (
              ...
              >
                ...
                <p className="font-medium text-sm mb-3 truncate">{logo.name}</p>
